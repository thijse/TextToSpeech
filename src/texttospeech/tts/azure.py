            ...
            if result.reason == speechsdk.ResultReason.VoicesListRetrieved:
                ...
                if result.reason == speechsdk.ResultReason.Canceled:
                    try:
                        ...
                        print(f"Error fetching voices: {cancellation_details.reason}, {cancellation_details.error_details}")
                    except Exception as inner_e:
                        print(f"Error fetching voices (canceled): {inner_e}")
                else:
    ...
    def text_to_speech(self, text, voice_name, output_path, output_format="mp3", is_ssml=False):
        ...
        Args:
            ...
            output_format (str, optional): The audio format to use. 
                                          ...
                                          Defaults to "mp3".
            is_ssml (bool, optional): Whether the text contains SSML markup. Defaults to False.
        ...
        try:
            ...
            print(f"Generating speech using voice '{voice_name}' ({'SSML' if is_ssml else 'text'})...")
            
            if is_ssml:
                # Wrap SSML content if needed
